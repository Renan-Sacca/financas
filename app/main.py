...
from app.api import routes_banks, routes_cards, routes_transactions, routes_summary, routes_transfers, routes_deposits, routes_categories, routes_auth, routes_bot, routes_recurring, routes_chat, routes_pending, routes_pending_bank
...
app.include_router(routes_pending.router)
app.include_router(routes_pending_bank.router)
